...
INSERT INTO users(ID, Password, FirstName, LastName, EmailAddress, LastAccess, EnrollDate, Enabled, Type)
VALUES(100739845, encode(digest('s83mhLi?3', 'sha1'), 'hex'), 'Sam', 'Freedman', 'samfreedman@gmail.com', '2021-06-04', '2022-07-01', true, 'f');
...
INSERT INTO faculty(ID, SchoolCode, SchoolDescription, Office, Extension)
VALUES(100739845, 'MIT', 'Massachusetts Institute of Technology', 'A477', 222);
