	...
	<div>
		...
		<div id="contentContainer">
			...
			<form method="post" action="./Register">
				...
				<label class="fixedlabel"> Program Code: </label> 
				<input type="text" name="code" value="<%=password %>" required/><br>
				
				<label class="fixedlabel"> Description: </label> 
				<input type="text" name="description" value="<%=password %>" required/><br>
				
				<label class="fixedlabel"> Year: </label> 
				<input type="text" name="year" value="<%=password %>" required/><br>
